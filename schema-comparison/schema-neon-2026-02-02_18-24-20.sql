...
COMMENT ON TABLE public.laudos IS 'Laudos psicológicos emitidos. NÃO devem ser criados antecipadamente.';
...
--
-- Name: funcionarios funcionarios_nivel_cargo_check; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--
