...
**Data:** 02/02/2026 18:24:24  
**Status:** ⚠️ **DIFERENÇAS ENCONTRADAS**

## Resultado

Foram encontradas **1386 linhas diferentes** entre local e produção.

### Estatísticas

| Métrica | Valor |
|---------|-------|
| Apenas no LOCAL | 1277 linhas |
| Apenas no NEON | 109 linhas |
| Total de diferenças | 1386 linhas |

### Detalhes

- **Schema Local:** .\schema-comparison\schema-local-2026-02-02_18-24-20.sql (265.67 KB)
- **Schema Neon:** .\schema-comparison\schema-neon-2026-02-02_18-24-20.sql (235.84 KB)
- **Arquivo de diferenças:** .\schema-comparison\schema-diff-2026-02-02_18-24-20.txt
...
1. [ ] Analisar arquivo de diferenças completo: `.\schema-comparison\schema-diff-2026-02-02_18-24-20.txt`
...
Get-Content ".\schema-comparison\schema-diff-2026-02-02_18-24-20.txt"
