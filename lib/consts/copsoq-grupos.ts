/**
 * Definição dos 10 grupos COPSOQ III com domínios, descrições e recomendações.
 * Metodologia: Tercis fixos de 33% e 66% da escala 0-100.
 *
 * Extraído de lib/laudo-calculos.ts para manter separação entre dados
 * estáticos de configuração e lógica de cálculo.
 */

export interface GrupoCOPSOQ {
  grupo: number;
  dominio: string;
  descricao: string;
...
export const gruposCOPSOQ: GrupoCOPSOQ[] = [
  {
    grupo: 1,
