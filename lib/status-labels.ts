...
export const COMISSAO_STATUS_BADGE: Record<string, StatusBadgeConfig> = {
  ...
  pendente_consolidacao: { label: 'Legado (Ciclo)', cor: 'bg-gray-200 text-gray-500' },
  pendente_nf: { label: 'Legado (NF)', cor: 'bg-gray-200 text-gray-500' },
  nf_em_analise: { label: 'Legado (Análise)', cor: 'bg-gray-200 text-gray-500' },
  congelada_rep_suspenso: { label: 'Congelada (Suspensão)', cor: 'bg-orange-100 text-orange-700' },
  congelada_aguardando_admin: { label: 'Aguardando Admin', cor: 'bg-yellow-100 text-yellow-700' },
