...
export const gerarContratoSimulado = (params: {
  ...
  if (
    !dadosContratante.nome ||
    !dadosContratante.cnpj ||
    !dadosContratante.endereco ||
    !dadosContratante.cidade ||
    !dadosContratante.estado ||
    !dadosContratante.email ||
    !dadosContratante.telefone ||
