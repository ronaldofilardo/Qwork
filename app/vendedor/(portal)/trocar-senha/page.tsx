...
export default function TrocarSenhaVendedorPage() {
  ...
  const handleSubmit = async (
    ...
    setSalvando(true);
    try {
      const res = await fetch('/api/vendedor/trocar-senha', {
        method: 'POST',
  ...
  const inputCls =
    'w-full border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-400 transition-all';
          ...
          {sucesso ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 bg-green-500 text-white text-sm font-semibold rounded-xl hover:bg-green-600 disabled:opacity-50 transition-colors cursor-pointer focus:ring-2 focus:ring-green-400 focus:outline-none"
              >
