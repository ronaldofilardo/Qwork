/**
 * POST /api/suporte/representantes/[id]/aprovar-comissao
 *
 * Suporte define o modelo de comissionamento (percentual ou custo_fixo)
 ...
 *
 * Acesso: suporte (sem restrição de ownership)
 */
...
export async function POST(
  ...
  try {
    ...
    // Suporte não tem restrição de ownership — pode aprovar qualquer representante
    ...
    console.info(
      JSON.stringify({
        event: 'suporte_definiu_modelo_comissao',
        representante_id: id,
        modelo,
