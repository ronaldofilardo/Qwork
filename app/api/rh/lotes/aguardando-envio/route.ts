...
export const GET = async (req: Request) => {
  ...
  try {
    ...
    console.log(
      '[DEBUG] GET /api/rh/lotes/aguardando-envio: user=',
      user,
      'empresaId=',
      empresaId,
      'limit=',
    ...
    try {
      ...
      console.log(
        '[DEBUG] requireRHWithEmpresaAccess falhou para aguardando-envio:',
        permError
      );
      return NextResponse.json(
        {
    ...
    console.error('Erro ao buscar lotes aguardando envio:', error);
    return NextResponse.json(
      {
