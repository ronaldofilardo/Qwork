...
/**
 * GET /api/rh/relatorio-lote-pdf?lote_id={loteId}
 * Gera relatório do lote com listagem de funcionários e conclusões
 */
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('[rh/relatorio-lote-pdf] Erro:', error);
    return NextResponse.json(
