...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Determinar clinica_id ou entidade_id: usar valor explícito se fornecido, senão tentar mapear via contratante_id quando perfil for 'rh' ou 'gestor'
    ...
    if (!entidadeId && body.perfil === 'gestor' && body.contratante_id) {
      // Para 'gestor', o contratante_id mapeia para entidade_id
      entidadeId = body.contratante_id;
    }
