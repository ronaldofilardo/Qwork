...
export async function POST(request: NextRequest) {
  ...
  // Extrair número estimado de funcionários
  ...
  // NOVO FLUXO: Contrato não é mais validado aqui - será gerado após aprovação
    ...
    const result = await db.transaction(async (txClient) => {
      ...
      const contratanteResult = await txClient.query<{
        ...
        `INSERT INTO contratantes (
          ...
          $11, $12, $13, $14, $15, $16, $17, $18, $19, false, false
      ...
      const contratoIdCreated: number | null = null;

      console.info(
        JSON.stringify({
          event: 'cadastro_contratante_created',
