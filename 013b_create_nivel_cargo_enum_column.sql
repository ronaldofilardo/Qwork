...
--
-- Name: gerar_codigo_lote(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--
...
ALTER FUNCTION public.gerar_codigo_lote() OWNER TO neondb_owner;
...
--
-- Name: verificar_cancelamento_automatico_lote(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--
...
ALTER FUNCTION public.verificar_cancelamento_automatico_lote() OWNER TO neondb_owner;

--
-- Name: FUNCTION verificar_cancelamento_automatico_lote(); Type: COMMENT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: verificar_conclusao_lote(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--
...
ALTER FUNCTION public.verificar_conclusao_lote() OWNER TO neondb_owner;

--
-- Name: FUNCTION verificar_conclusao_lote(); Type: COMMENT; Schema: public; Owner: neondb_owner
--
...
COPY public.funcionarios (id, cpf, nome, setor, funcao, email, senha_hash, perfil, ativo, criado_em, atualizado_em, clinica_id, empresa_id, matricula, turno, escala, nivel_cargo) FROM stdin;
13	00000000000	Admin Sistema	\N	\N	admin@qwork.com	$2a$10$Jw7ZrRCFDkjXrfM2/U86ZeHFL6dCksUqRAxBfcL1hOKYV1e//Jz4W	admin	t	2026-02-02 19:27:25.561299	2026-02-02 19:27:31.077604	\N	\N	\N	\N	\N	\N
\.
...
COPY public.lotes_avaliacao (id, codigo, clinica_id, empresa_id, titulo, descricao, tipo, status, liberado_por, liberado_em, criado_em, atualizado_em, laudo_enviado_em, finalizado_em, numero_ordem, contratante_id, processamento_em) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.auditoria_laudos_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.contratacao_personalizada_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.contratantes_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.empresas_clientes_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.fila_emissao_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.respostas_id_seq', 1, false);
...
--
-- Name: empresas_clientes empresas_clientes_cnpj_clinica_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: funcionarios funcionarios_nivel_cargo_check; Type: CHECK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE public.funcionarios
    ADD CONSTRAINT funcionarios_nivel_cargo_check CHECK (((((perfil)::text = ANY ((ARRAY['admin'::character varying, 'emissor'::character varying])::text[])) AND (nivel_cargo IS NULL)) OR (((perfil)::text = ANY ((ARRAY['funcionario'::character varying, 'rh'::character varying])::text[])) AND (nivel_cargo = ANY (ARRAY['operacional'::public.nivel_cargo_enum, 'gestao'::public.nivel_cargo_enum]))))) NOT VALID;
...
--
-- Name: lotes_avaliacao lotes_avaliacao_codigo_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_lotes_codigo; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: empresas_clientes; Type: ROW SECURITY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: empresas_clientes empresas_rh_insert; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: empresas_clientes empresas_rh_update; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: funcionarios funcionarios_rh_delete; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: funcionarios funcionarios_rh_insert; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: funcionarios funcionarios_rh_select; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: funcionarios funcionarios_rh_update; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: lotes_avaliacao lotes_rh_insert; Type: POLICY; Schema: public; Owner: neondb_owner
--
...
--
-- Name: lotes_avaliacao lotes_rh_update; Type: POLICY; Schema: public; Owner: neondb_owner
--
