/**
 * __tests__/api/entidade/funcionarios-auto-inclusao.test.ts
 *
 * Testes de integração para bloqueio de auto-inclusão do Gestor como funcionário
 */

import { limparCPF } from '@/lib/cpf-utils';

describe('Entidade Auto-inclusão Validação', () => {
