...
describe('Migration 1008 - API Corrections', () => {
  ...
  describe('Segregação de Arquitetura - lotes_avaliacao', () => {
    it('deve garantir lote tem APENAS clinica_id + empresa_id OU entidade_id', () => {
      ...
      const clinicaValida = (lote_clinica.clinica_id !== null) && 
      ...
      const entidadeValida = (lote_entidade.clinica_id === null) && 
      ...
      const invalida = (lote_invalido.clinica_id !== null) && 
                       (lote_invalido.entidade_id !== null);
  ...
  describe('Backward Compatibility - DEV vs PROD', () => {
    ...
    it('deve funcionar quando APENAS contratante_id está preenchido (PROD antigo)', () => {
      ...
      const coalesceResult = lote_prod_antigo.entidade_id || lote_prod_antigo.contratante_id;
    ...
    it('deve funcionar quando AMBOS estão preenchidos (pós-trigger)', () => {
      ...
      const coalesceResult = lote_sincronizado.entidade_id || lote_sincronizado.contratante_id;
