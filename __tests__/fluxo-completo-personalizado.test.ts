...
describe('Fluxo Completo Plano Personalizado - AAA Entidade', () => {
  ...
  it('1. Estado inicial: aguardando_valor_admin', async () => {
    ...
    console.log(`Contratação Status: ${contratante.contratacao_status}`);
  ...
  it('2. Admin define valor e gera link', async () => {
    ...
    console.log(`Status Contratação: ${contratacao.status}`);
    console.log(
    ...
    console.log(`Valor Total: R$ ${contratacao.valor_total_estimado}`);
    console.log(`Token: ${contratacao.payment_link_token.substring(0, 20)}...`);
    console.log(
  ...
  it('3. Verificar notificação gerada para gestor', async () => {
    ...
    console.log(`Destinatário CPF: ${notificacao.destinatario_cpf}`);
    console.log(`Título: ${notificacao.titulo}`);
    console.log(`Mensagem: ${notificacao.mensagem.substring(0, 100)}...`);
    console.log(`Link Ação: ${notificacao.link_acao}`);
    console.log(`Botão: ${notificacao.botao_texto}`);
  ...
  it('4. Verificar contrato criado', async () => {
    ...
    console.log(`Plano ID: ${contrato.plano_id}`);
    console.log(`Número Funcionários: ${contrato.numero_funcionarios}`);
    console.log(`Valor Total: R$ ${contrato.valor_total}`);
    console.log(`Status: ${contrato.status}`);
    console.log(`Aceito: ${contrato.aceito}`);
    console.log(`Pagamento Confirmado: ${contrato.pagamento_confirmado}`);
