 ...
 * Testes: ModalCadastrotomador - validações de planos
 */
...
describe.skip('ModalCadastrotomador - validações de planos [LEGADO: sistema de planos removido em migration 1136]', () => {
  beforeEach(() => {
