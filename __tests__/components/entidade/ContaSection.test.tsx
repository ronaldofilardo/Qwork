...
describe('EntidadeContaSection', () => {
  ...
  it('deve exibir Representante Comercial quando entidade possui vínculo ativo', async () => {
    const mockWithRep = {
      ...mockAccountData,
      representante: {
    ...
    expect(screen.getByText('ana@rep.com')).toBeInTheDocument();
    expect(screen.getByText('(11) 97654-3210')).toBeInTheDocument();
  });

  it('não deve exibir Representante Comercial quando entidade não possui vínculo', async () => {
    const mockWithoutRep = {
      ...mockAccountData,
      representante: null,
    };
