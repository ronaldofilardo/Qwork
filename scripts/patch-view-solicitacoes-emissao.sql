-- Patch: recriar v_solicitacoes_emissao em PROD igual ao STAGING
-- STAGING tem 42 cols: adicionados representante_percentual_comissao_comercial, modelo_comissionamento, valor_custo_fixo_snapshot
-- PROD tinha 40 cols: tinha representante_codigo (removido no STAGING via migration 1227)
