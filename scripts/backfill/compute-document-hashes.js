#!/usr/bin/env node
/**
 * Script: compute-document-hashes.js
 * Objetivo: Calcular SHA-256 e tamanho dos arquivos referenciados em documentos_contratacao
 * e atualizar os registros no banco.
 * Uso: node compute-document-hashes.js --dry-run
 */
