...
-- Para criar gestor de ENTIDADE (gestor), usar contratante_id com tipo='entidade'
...
-- VALUES (...cpf..., ...nome..., ...email..., 'gestor', ...contratante_id..., NULL, NULL, 'Gestor', ...hash..., true, 'gestao');
