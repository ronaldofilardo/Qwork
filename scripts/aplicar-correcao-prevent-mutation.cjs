// Script Node.js: Aplicar correção da função prevent_mutation_during_emission
// Data: 10/02/2026
// Uso: node scripts/aplicar-correcao-prevent-mutation.cjs

const { Client } = require('pg');
const fs = require('fs');
const path = require('path');

// Carregar DATABASE_URL do .env.production.local manualmente
...
async function aplicarCorrecao() {
  ...
  try {
    console.log('=============================================');
    console.log('  CORREÇÃO URGENTE: prevent_mutation_during_emission');
    console.log('=============================================\n');
    ...
    console.log('PASSO 1: Verificando função atual...');
    ...
    console.log('PASSO 2: Aplicando correção...');
    await client.query(migrationSQL);
    console.log('✅ Correção aplicada com sucesso!\n');

    console.log('PASSO 3: Validando...');
