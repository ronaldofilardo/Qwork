...
$migrations = @(
    ...
    @{ File = "1204_custo_fixo_por_representante.sql";                    Label = "1204a custo_fixo_por_representante" },
    @{ File = "1204_remove_proposta_comercial_colunas.sql";               Label = "1204b remove_proposta_comercial_colunas" },
