  ...
  for (const loteId of args) {
    try {
      const res = await query(
        `SELECT la.id as lote_id, la.clinica_id, la.empresa_id, la.contratante_id, la.emitido_em, la.enviado_em, la.auto_emitir_em, l.id as laudo_id, l.status as status_l
