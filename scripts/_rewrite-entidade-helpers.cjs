// scripts/_rewrite-entidade-helpers.cjs
const fs = require('fs');
const path = require('path');

const target = path.join(__dirname, '..', 'lib', 'db', 'entidade-helpers.ts');
...
console.log(
  'OK: entidade-helpers.ts rewritten as adapter (' + lines.length + ' lines)'
);
