-- Cria funo para calcular elegibilidade de lote por contratante (entidade)
-- Baseada em calcular_elegibilidade_lote, mas filtra por contratante_id e funcionrios sem empresa_id
