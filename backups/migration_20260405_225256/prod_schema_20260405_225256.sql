...
BEGIN
  INSERT INTO public.comissionamento_auditoria (
    ...
    COALESCE(p_cpf, public.current_user_cpf())
  );
END;
$$;
...
--
-- Name: trg_criar_comissao_ao_emitir_laudo(); Type: FUNCTION; Schema: public; Owner: neondb_owner
--

CREATE FUNCTION public.trg_criar_comissao_ao_emitir_laudo() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _vinculo          RECORD;
...
ALTER FUNCTION public.trg_criar_comissao_ao_emitir_laudo() OWNER TO neondb_owner;
...
--
-- Name: asaas_pagamentos; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.asaas_pagamentos (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    pagamento_id integer NOT NULL,
    asaas_subscription_id character varying(255),
    asaas_customer_id character varying(255),
    asaas_invoice_id character varying(255),
    asaas_status character varying(50),
    valor_original numeric(10,2),
    taxa_asaas numeric(10,2),
    valor_liquido numeric(10,2),
    pix_qr_code text,
    pix_copy_paste text,
    pix_expiration timestamp without time zone,
    boleto_numero character varying(47),
    boleto_link_pdf character varying(500),
...
ALTER TABLE public.asaas_pagamentos OWNER TO neondb_owner;
...
--
-- Name: COLUMN comissoes_laudo.auto_cancelamento_em; Type: COMMENT; Schema: public; Owner: neondb_owner
--
...
CREATE TABLE public.pagamentos (
    ...
    clinica_id integer,
    tomador_id integer,
    origem_pagamento character varying(50) DEFAULT 'asaas'::character varying,
...
COMMENT ON VIEW public.v_solicitacoes_emissao IS 'View para admin gerenciar solicitações de emissão. Inclui dados de representante vinculado, percentual de comissão e flag de comissão gerada. Atualizada em 03/03/2026 (migration 503).';
...
--
-- Name: asaas_pagamentos asaas_pagamentos_asaas_invoice_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.asaas_pagamentos
    ADD CONSTRAINT asaas_pagamentos_asaas_invoice_id_key UNIQUE (asaas_invoice_id);


--
-- Name: asaas_pagamentos asaas_pagamentos_asaas_subscription_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.asaas_pagamentos
    ADD CONSTRAINT asaas_pagamentos_asaas_subscription_id_key UNIQUE (asaas_subscription_id);


--
-- Name: asaas_pagamentos asaas_pagamentos_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.asaas_pagamentos
    ADD CONSTRAINT asaas_pagamentos_pkey PRIMARY KEY (id);
...
--
-- Name: vinculos_comissao vinculo_unico_ativo; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: idx_aceites_entidade_responsavel; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_aceites_entidade_responsavel ON public.aceites_termos_entidade USING btree (responsavel_cpf);
...
--
-- Name: idx_aceites_usuario_entidade; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_aceites_usuario_entidade ON public.aceites_termos_usuario USING btree (usuario_entidade_id);
...
--
-- Name: idx_asaas_pagamentos_created; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_asaas_pagamentos_created ON public.asaas_pagamentos USING btree (criado_em DESC);


--
-- Name: idx_asaas_pagamentos_customer_id; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_asaas_pagamentos_customer_id ON public.asaas_pagamentos USING btree (asaas_customer_id);


--
-- Name: idx_asaas_pagamentos_invoice_id; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_asaas_pagamentos_invoice_id ON public.asaas_pagamentos USING btree (asaas_invoice_id);


--
-- Name: idx_asaas_pagamentos_pagamento_id; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_asaas_pagamentos_pagamento_id ON public.asaas_pagamentos USING btree (pagamento_id);


--
-- Name: idx_asaas_pagamentos_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_asaas_pagamentos_status ON public.asaas_pagamentos USING btree (asaas_status);
...
--
-- Name: idx_comissoes_auto_cancelamento; Type: INDEX; Schema: public; Owner: neondb_owner
--
...
--
-- Name: laudos trg_laudo_emitido_gerar_comissao; Type: TRIGGER; Schema: public; Owner: neondb_owner
--

CREATE TRIGGER trg_laudo_emitido_gerar_comissao AFTER UPDATE ON public.laudos FOR EACH ROW EXECUTE FUNCTION public.trg_criar_comissao_ao_emitir_laudo();
...
--
-- Name: asaas_pagamentos fk_pagamento; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.asaas_pagamentos
    ADD CONSTRAINT fk_pagamento FOREIGN KEY (pagamento_id) REFERENCES public.pagamentos(id) ON DELETE CASCADE;
...
CREATE POLICY comissoes_rep_own ON public.comissoes_laudo USING (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text))) WITH CHECK (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text)));
...
CREATE POLICY leads_rep_own ON public.leads_representante USING (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text))) WITH CHECK (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text)));
...
CREATE POLICY rep_sees_own ON public.representantes FOR SELECT USING (((id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text)));
...
CREATE POLICY rep_update_own ON public.representantes FOR UPDATE USING (((id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text))) WITH CHECK (((id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text)));
...
CREATE POLICY vinculos_rep_own ON public.vinculos_comissao USING (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text))) WITH CHECK (((representante_id = public.current_representante_id()) OR (public.current_user_perfil() = 'admin'::text)));
