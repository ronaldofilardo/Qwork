...
Database: neondb_v2
Connection String: postgresql://neondb_owner:REDACTED@ep-divine-sky-acuderi7-pooler.sa-east-1.aws.neon.tech/neondb_v2
```
...
### Validar DB
```bash
export PGPASSWORD="REDACTED_NEON_PASSWORD"
export PGSSLMODE="require"
