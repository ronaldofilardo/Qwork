...
BEGIN
  ...
  WHERE 
    ...
    AND (
      ...
      OR
      -- Critério 2: �ndice incompleto (faltou lote anterior)
...
-- ==========================================
-- 3. FUNÇÃO: DETECTAR ANOMALIAS NO �NDICE
-- ==========================================
...
-- ==========================================
-- 4. FUNÇÃO: CHECK PRÉ-LAUDO (Validar �ndice Completo)
-- ==========================================
...
BEGIN
    ...
    RAISE NOTICE 'FUNCTIONS 016 CONCLU�DAS COM SUCESSO!';
