...
CREATE TABLE public.funcionarios (
    ...
    CONSTRAINT funcionarios_clinica_check CHECK ((clinica_id IS NOT NULL OR perfil = 'emissor')),
    CONSTRAINT funcionarios_perfil_check CHECK (((perfil)::text = ANY ((ARRAY['funcionario'::character varying, 'rh'::character varying, 'admin'::character varying, 'emissor'::character varying])::text[])))
);
...
CREATE TABLE public.lotes_avaliacao (
    ...
    criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    atualizado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT lotes_avaliacao_status_check CHECK (((status)::text = ANY ((ARRAY['ativo'::character varying, 'cancelado'::character varying, 'finalizado'::character varying, 'concluido'::character varying, 'rascunho'::character varying])::text[]))),
...
--
-- Name: lotes_avaliacao_funcionarios; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.lotes_avaliacao_funcionarios (
    id integer NOT NULL,
    lote_id integer NOT NULL,
    funcionario_id integer NOT NULL,
    avaliacao_id integer,
    criado_em timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT lotes_avaliacao_funcionarios_pkey PRIMARY KEY (id),
    CONSTRAINT lotes_avaliacao_funcionarios_lote_id_fkey FOREIGN KEY (lote_id) REFERENCES public.lotes_avaliacao(id) ON DELETE CASCADE,
    CONSTRAINT lotes_avaliacao_funcionarios_funcionario_id_fkey FOREIGN KEY (funcionario_id) REFERENCES public.funcionarios(id) ON DELETE CASCADE,
    CONSTRAINT lotes_avaliacao_funcionarios_avaliacao_id_fkey FOREIGN KEY (avaliacao_id) REFERENCES public.avaliacoes(id) ON DELETE SET NULL
);

ALTER TABLE public.lotes_avaliacao_funcionarios OWNER TO postgres;

--
-- Name: lotes_avaliacao_funcionarios_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.lotes_avaliacao_funcionarios_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;

ALTER SEQUENCE public.lotes_avaliacao_funcionarios_id_seq OWNER TO postgres;

--
-- Name: lotes_avaliacao_funcionarios_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.lotes_avaliacao_funcionarios_id_seq OWNED BY public.lotes_avaliacao_funcionarios.id;

--
-- Name: lotes_avaliacao_funcionarios id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lotes_avaliacao_funcionarios ALTER COLUMN id SET DEFAULT nextval('public.lotes_avaliacao_funcionarios_id_seq'::regclass);

--
-- Name: idx_lotes_avaliacao_funcionarios_lote; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_lotes_avaliacao_funcionarios_lote ON public.lotes_avaliacao_funcionarios USING btree (lote_id);

--
-- Name: idx_lotes_avaliacao_funcionarios_funcionario; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_lotes_avaliacao_funcionarios_funcionario ON public.lotes_avaliacao_funcionarios USING btree (funcionario_id);
...
--
-- Name: lotes_avaliacao_funcionarios lotes_avaliacao_funcionarios_lote_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lotes_avaliacao_funcionarios
ADD CONSTRAINT lotes_avaliacao_funcionarios_lote_id_fkey FOREIGN KEY (lote_id) REFERENCES public.lotes_avaliacao (id) ON DELETE CASCADE;

--
-- Name: lotes_avaliacao_funcionarios lotes_avaliacao_funcionarios_funcionario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lotes_avaliacao_funcionarios
ADD CONSTRAINT lotes_avaliacao_funcionarios_funcionario_id_fkey FOREIGN KEY (funcionario_id) REFERENCES public.funcionarios (id) ON DELETE CASCADE;

--
-- Name: lotes_avaliacao_funcionarios lotes_avaliacao_funcionarios_avaliacao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lotes_avaliacao_funcionarios
ADD CONSTRAINT lotes_avaliacao_funcionarios_avaliacao_id_fkey FOREIGN KEY (avaliacao_id) REFERENCES public.avaliacoes (id) ON DELETE SET NULL;
...
CREATE INDEX IF NOT EXISTS idx_contratos_numero_funcionarios ON public.contratos (numero_funcionarios);
