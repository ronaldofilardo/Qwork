-- Migration 211: Create DBA Maintenance Role with BYPASSRLS
-- Created: 2026-01-29
...
-- ========================================
-- PART 2: Audit configuration
-- ========================================

-- Force logging of all statements
ALTER ROLE dba_maintenance SET log_statement = 'all';
ALTER ROLE dba_maintenance SET log_min_duration_statement = 0;
-- Note: log_connections and log_disconnections must be set in postgresql.conf
...
COMMENT ON ROLE dba_maintenance IS
  'DBA maintenance role with BYPASSRLS for critical operations.
   ...
   USAGE:
   psql -U dba_maintenance -d dbname
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Migration 211 completed successfully!';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Role: dba_maintenance';
  RAISE NOTICE 'BYPASSRLS: enabled';
  RAISE NOTICE 'Connection limit: 2';
  RAISE NOTICE 'Audit: FULL (all statements logged)';
  RAISE NOTICE '========================================';
