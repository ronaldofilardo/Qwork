...
-- Description: Fix RLS policies to accept both 'entidade' and 'gestor_entidade' perfil
-- Date: 2026-01-04
-- Priority: P0.2 - CRÍTICA

BEGIN;

\echo '=== MIGRATION 064: Corrigindo perfil gestor_entidade em RLS ==='
...
-- Aceita ambos 'entidade' e 'gestor_entidade' para compatibilidade
...
\echo '064.1 Políticas RLS de lotes_avaliacao atualizadas para aceitar gestor_entidade'
...
\echo '064.2 Política RLS de laudos atualizada para aceitar gestor_entidade'

-- Add comment explaining the dual perfil support
COMMENT ON POLICY lotes_entidade_select ON public.lotes_avaliacao IS 
'Permite acesso de gestores de entidade (perfil gestor_entidade ou entidade) aos lotes da sua entidade';
