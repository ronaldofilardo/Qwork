-- Migration 070: Atualiza constraint funcionarios_nivel_cargo_check para aceitar 'gestor'
-- Data: 2026-01-05
...
-- Criar nova constraint incluindo 'gestor' e marcando NOT VALID para migração segura
