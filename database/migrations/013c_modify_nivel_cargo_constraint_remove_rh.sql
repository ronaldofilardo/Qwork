-- MIGRATION 013c: Remover nivel_cargo de perfis que não devem tê-lo (rh, gestor) e ajustar constraint
-- Data: 2026-01-23
-- Objetivo: Corrigir atribuição indevida de nivel_cargo para perfis de gestão (rh, gestor)
...
ALTER TABLE funcionarios
  ADD CONSTRAINT funcionarios_nivel_cargo_check CHECK (
    (perfil IN ('admin','emissor','rh','gestor') AND nivel_cargo IS NULL) OR
