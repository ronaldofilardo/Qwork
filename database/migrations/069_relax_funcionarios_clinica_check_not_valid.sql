...
-- Adicionar nova constraint incluindo 'gestor' e marcá-la NOT VALID para não bloquear dados existentes
...
COMMENT ON CONSTRAINT funcionarios_clinica_check ON funcionarios IS 'Permite funcionarios sem clinica_id quando perfil é emissor, admin ou gestor (NOT VALID para permitir migração incremental)';
