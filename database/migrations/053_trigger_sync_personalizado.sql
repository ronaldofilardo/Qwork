-- Migração 053: Trigger para sincronização de estados entre contratacao_personalizada e contratantes
-- Data: 19/01/2026
...
COMMENT ON FUNCTION sync_personalizado_status() IS 'Sincroniza automaticamente status entre contratacao_personalizada e contratantes';
