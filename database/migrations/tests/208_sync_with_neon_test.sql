-- Migration 208: Sync test database with Neon production (adapted)
-- Created: 2026-01-29
-- Purpose: Add missing tables and permissions from Neon to test database
...
-- 5. Skip fila_emissao (already exists with different structure in test DB)
...
-- 9. Skip RLS policies (test DB has simplified structure)

-- Verification
DO $$
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Migration 208 (test) completed!';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Added:';
  RAISE NOTICE '- 2 new permissions (manage:rh, manage:admins)';
  RAISE NOTICE '- 6 new tables (fila_emissao skipped)';
  RAISE NOTICE '========================================';
END $$;
