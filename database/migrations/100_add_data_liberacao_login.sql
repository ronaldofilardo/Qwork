-- Migration: Adicionar coluna data_liberacao_login na tabela tomadores
-- Data: 2026-01-23
...
COMMENT ON COLUMN tomadores.data_liberacao_login 
IS 'Data em que o login foi liberado após confirmação de pagamento';

-- Criar índice para consultas de auditoria
CREATE INDEX IF NOT EXISTS idx_tomadores_data_liberacao 
ON tomadores (data_liberacao_login);
