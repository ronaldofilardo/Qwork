...
-- Data: 2026-01-30
-- Descrição: Insere gestores de entidade que estavam liberando lotes mas não constavam em entidades_senhas

-- ============================================
-- ANÁLISE DO PROBLEMA:
-- ============================================
-- Encontrados 7 lotes "desconectados" onde liberado_por não estava em entidades_senhas:
...
--
-- CONFIRMAÇÕES:
-- - CPF 87545772920 é gestor do contratante 1 (CNPJ 02.494.916/0001-70 - RLGR)
-- - CPF 16543102047 é gestor do contratante 5 (CNPJ 37.024.309/0001-21 - Amanda Ltda)
-- - CPF 04703084945 já estava correto (contratante 2)

-- ============================================
-- CORREÇÃO: Inserir gestores faltantes
-- ============================================
-- REGRA: Senha para RH e gestor = 6 últimos dígitos do CNPJ
...
INSERT INTO entidades_senhas (cpf, contratante_id, senha_hash, primeira_senha_alterada)
VALUES (
  '87545772920', 
  1, 
...
BEGIN
  ...
  INNER JOIN entidades_senhas cs ON cs.cpf = l.liberado_por
