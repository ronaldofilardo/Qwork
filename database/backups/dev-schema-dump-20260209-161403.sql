...
--
-- Name: sync_entidade_contratante_id(); Type: FUNCTION; Schema: public; Owner: -
--
...
COMMENT ON VIEW public.v_solicitacoes_emissao IS 'View consolidada de solicita̵̤es de emisṣo de laudos com informa̵̤es de pagamento. Usa entidades/clinicas (gestores/RH) ao inv̩s das antigas tabelas empresas_clientes/tomadors.';
...
--
-- Name: lotes_avaliacao trg_sync_entidade_contratante; Type: TRIGGER; Schema: public; Owner: -
--
