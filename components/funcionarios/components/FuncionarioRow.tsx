        ...
        {hasEval ? (
          <div className="flex flex-col gap-1">
            <div className="flex items-center gap-2">
              ...
              <span
                className={`inline-flex px-2 py-0.5 text-xs font-semibold rounded-full ${funcionario.ultima_avaliacao_status === 'concluido' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}
                title={
            ...
            {(() => {
              ...
              if (!formatted && funcionario.ultima_inativacao_em) {
                return (
            ...
            {funcionario.tem_avaliacao_recente &&
              funcionario.data_ultimo_lote && (
                <div className="mt-1">
                  ...
                  >
                    ✓ Avaliação válida (
                    {new Date(funcionario.data_ultimo_lote).toLocaleDateString(
                      'pt-BR'
                    )}
                    )
                  </span>
          ...
          <span className="text-sm text-gray-400">Nunca avaliado</span>
        )}
      </td>
