                    ...
                    {(() => {
                      ...
                      return (
                        <div className="text-xs text-gray-500">
                          ...
                          !Array.isArray(plano.caracteristicas) &&
                          typeof plano.caracteristicas === 'object' &&
                          (plano.caracteristicas as Record<string, any>)
                            .parcelas_max ? (
                            <div className="text-xs text-gray-500">
                              Até{' '}
                              {
            ...
            <div className="mt-4 p-4 border rounded-lg bg-gray-50">
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  min={
                    planoSelecionado.tipo === 'personalizado' ||
                    Array.isArray(planoSelecionado.caracteristicas)
                      ? 1
                      : (
                          planoSelecionado.caracteristicas as Record<
                            string,
                            any
                          >
                        )?.minimo_funcionarios || 1
                  }
                  max={
                    planoSelecionado.tipo === 'personalizado' ||
                    Array.isArray(planoSelecionado.caracteristicas)
                ...
                {planoSelecionado.tipo === 'fixo' && (
                  <div className="text-sm text-gray-700">
                    ...
                    <div className="text-xs text-gray-500">
                      {!Array.isArray(planoSelecionado.caracteristicas) &&
                      (planoSelecionado.caracteristicas as Record<string, any>)
                        ?.parcelas_max
                        ? `Pagamento em até ${(planoSelecionado.caracteristicas as Record<string, any>).parcelas_max}x`
