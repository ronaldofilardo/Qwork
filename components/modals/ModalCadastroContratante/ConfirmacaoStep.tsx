  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border rounded-lg p-4 space-y-2">
        ...
        <p className="text-sm">
          <strong>Razão Social:</strong> {dadosContratante.nome}
        </p>
        <p className="text-sm">
          <strong>CNPJ:</strong> {dadosContratante.cnpj}
        </p>
        <p className="text-sm">
          <strong>Email:</strong> {dadosContratante.email}
        </p>
        <p className="text-sm">
          <strong>Telefone:</strong> {dadosContratante.telefone}
        </p>
        <p className="text-sm">
          <strong>Endereço:</strong> {dadosContratante.endereco},{' '}
          {dadosContratante.cidade}/{dadosContratante.estado}
        </p>
      </div>
      ...
      <div className="border-2 border-orange-300 rounded-lg p-4 bg-orange-50">
        <label className="flex items-start gap-3 cursor-pointer">
          ...
          <span className="text-sm text-gray-800">
            ...
            e estou ciente de que, após o envio, o cadastro entrará em análise.
